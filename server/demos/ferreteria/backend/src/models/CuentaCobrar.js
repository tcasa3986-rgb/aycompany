...
const CuentaCobrar = sequelize.define('CuentaCobrar', {
    venta_id: { type: DataTypes.INTEGER, allowNull: false, unique: true },
...
}, { tableName: 'cuentas_cobrar', timestamps: true, underscored: true });

module.exports = CuentaCobrar;
