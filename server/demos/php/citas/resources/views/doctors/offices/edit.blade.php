<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-3">
            ...
            Editar Consultorio — Dr. {{ $doctor->user->name }}
        </div>
    </x-slot>

    <div class="max-w-2xl mx-auto">
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
            <form action="{{ route('doctors.offices.update', [$doctor, $office]) }}" method="POST" class="space-y-5">
                @csrf @method('PUT')
                ...
                <div class="grid grid-cols-2 gap-5">
                    <div>
                        ...
                        <input type="text" name="floor" value="{{ old('floor', $office->floor) }}"
                            class="w-full rounded-lg border border-gray-200 px-4 py-2 text-sm focus:ring-2 focus:ring-blue-400">
                    </div>
                    <div>
                ...
                <div>
                    ...
                    <input type="url" name="maps_url" value="{{ old('maps_url', $office->maps_url) }}"
                        class="w-full rounded-lg border border-gray-200 px-4 py-2 text-sm focus:ring-2 focus:ring-blue-400">
                ...
                <div class="pt-2 pb-4">
                    <label class="flex items-center gap-3 cursor-pointer">
                        ...
                        <input type="checkbox" name="is_active" value="1" {{ old('is_active', $office->is_active) ? 'checked' : '' }} class="w-5 h-5 text-blue-600 rounded border-gray-300 focus:ring-blue-500">
