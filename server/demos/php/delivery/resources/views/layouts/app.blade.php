...
<nav id="sidebar">
    ...
    <ul class="nav flex-column sidebar-nav py-2">
        @role('repartidor')
        <li><a href="{{ route('repartidor.index') }}" class="nav-link {{ request()->routeIs('repartidor.*') ? 'active' : '' }}">
            <i class="bi bi-bicycle"></i><span>Mis Entregas</span>
        </a></li>
        @endrole
        ...
        @can('editar pedidos')
        <li><a href="{{ route('cupones.index') }}" class="nav-link {{ request()->routeIs('cupones.*') ? 'active' : '' }}">
            <i class="bi bi-ticket-perforated"></i><span>Cupones</span>
        </a></li>
        @endcan
        ...
        <li><a href="{{ route('inventario.index') }}" class="nav-link {{ request()->routeIs('inventario.*') ? 'active' : '' }}">
        ...
        <li><a href="{{ route('zonas.index') }}" class="nav-link {{ request()->routeIs('zonas.*') ? 'active' : '' }}">
            <i class="bi bi-geo-alt"></i><span>Zonas Delivery</span>
        </a></li>
        ...
        @role('super-admin')
        <li><a href="{{ route('backups.index') }}" class="nav-link {{ request()->routeIs('backups.*') ? 'active' : '' }}">
            <i class="bi bi-shield-lock"></i><span>Backup / Reset</span>
        </a></li>
        @endrole
