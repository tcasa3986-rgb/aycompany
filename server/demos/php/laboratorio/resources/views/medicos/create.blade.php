@extends('layouts.app')
@section('title', 'Nuevo Médico Referidor')
@section('content')
<div class="page-header">
    <div>
        <h1 class="page-title text-gradient">Registrar Médico Referidor</h1>
    </div>
...
<div class="card" style="max-width:700px;">
    ...
    <form method="POST" action="{{ route('medicos.store') }}" style="padding:1.5rem;">
        @csrf
        @if($errors->any())
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:1rem;">
            <div class="form-group col-2-span">
                ...
                <input type="text" name="cmp" class="form-control" value="{{ old('cmp') }}" placeholder="Ej: 12345">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="especialidad" class="form-control" value="{{ old('especialidad') }}" placeholder="Ej: Cardiología">
            </div>
            <div class="form-group">
