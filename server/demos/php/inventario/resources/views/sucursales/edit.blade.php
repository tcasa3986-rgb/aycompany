<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="text-2xl font-bold text-white">Editar Sucursal</h2>
            ...
            <form action="{{ route('sucursales.update', $sucursale) }}" method="POST">
                ...
                <div class="space-y-6">
                    <div>
                        ...
                        <input type="text" name="nombre" value="{{ old('nombre', $sucursale->nombre) }}" required
                    ...
                    <div>
                        ...
                        <textarea name="direccion" rows="3"
                            class="w-full bg-gray-700 border-gray-600 text-white rounded-lg focus:ring-2 focus:ring-blue-500 @error('direccion') border-red-500 @enderror">{{ old('direccion', $sucursale->direccion) }}</textarea>
                        @error('direccion')
                            <p class="text-red-400 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="telefono" value="{{ old('telefono', $sucursale->telefono) }}"
