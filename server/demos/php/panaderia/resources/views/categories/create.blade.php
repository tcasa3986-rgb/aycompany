                    ...
                    <form action="{{ route('categories.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="description" id="description" rows="3"
                                class="mt-1 focus:ring-bakery-gold focus:border-bakery-gold block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"></textarea>
                        </div>
                        ...
                        <div class="flex justify-end">
                            ...
                            <button type="submit"
                                class="bg-bakery-gold hover:bg-bakery-dark text-white font-bold py-2 px-4 rounded">Guardar</button>
                        </div>
                    </form>
                </div>
            </div>
